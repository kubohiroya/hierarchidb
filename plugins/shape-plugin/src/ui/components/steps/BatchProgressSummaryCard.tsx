...
import type { TaskWithMetadata } from './ShapeBuildProgressTaskList.tsx';
import { useTranslation } from '@hierarchidb/ui-i18n';

type BatchProgressSummaryCardProps = {
  summary: ShapeBuildProgressSummary;
  stages: BuildStage[];
  tasksByStage: Record<string, TaskWithMetadata[]>;
};

export const BatchProgressSummaryCard = ({
                                    summary,
                                    stages,
                                    tasksByStage
                                  }: BatchProgressSummaryCardProps) => {
