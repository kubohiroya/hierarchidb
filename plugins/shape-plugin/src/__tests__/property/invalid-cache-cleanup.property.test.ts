...
describe('Property 8: Invalid Cache Cleanup', () => {
   ...
   */
  it(
    'should identify and delete all invalid geometry cache entries',
    { timeout: 15000 },
    async () => {
      await fc.assert(
        fc.asyncProperty(
   ...
   */
  it(
    'should identify and delete all invalid source cache entries',
    { timeout: 15000 },
    async () => {
      await fc.assert(
        fc.asyncProperty(
   ...
   */
  it(
    'should cleanup invalid entries from both geometry and source caches',
    { timeout: 15000 },
    async () => {
      await fc.assert(
        fc.asyncProperty(
   ...
   */
  it(
    'should be idempotent - multiple cleanups produce same result',
    { timeout: 15000 },
    async () => {
      await fc.assert(
        fc.asyncProperty(
