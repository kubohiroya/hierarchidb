import { HostProfileRegistry, type StepComponentProps, type PluginStepConfig } from '@hierarchidb/runtime-plugin-dialog';
import { BasicInfoStep } from '@hierarchidb/runtime-plugin-dialog';
