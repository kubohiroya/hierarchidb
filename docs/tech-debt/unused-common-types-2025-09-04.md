...
interface | BaseNodeDefinition — packages/common/types/src/batch-types.ts
...
interface | ExtendedFieldDefinition — packages/common/types/src/batch-types.ts
interface | ExtensionMetadata — packages/common/types/src/batch-types.ts
