...
interface | BaseNodeDefinition — packages/common/types/src/build-types.ts
...
interface | ExtendedFieldDefinition — packages/common/types/src/build-types.ts
interface | ExtensionMetadata — packages/common/types/src/build-types.ts
