...
- 実装ファイル: `packages/node-type-plugin/spreadsheet/src/extension/definition.ts`（未作成）
- テストファイル: `packages/node-type-plugin/spreadsheet/src/extension/definition.test.ts`
...
`packages/node-type-plugin/spreadsheet/src/extension/definition.test.ts`に作成完了。
