...
export const shapesPlugin: PluginConfig = {
  ...
  name: 'Shapes Plugin', 
  version: '1.0.0',
  description: 'Geospatial shape_obsolate data management with build processing and vector tiles',
...
import { CommonDialog } from '@hierarchidb/ui-core/containers/console/CommonDialog';
