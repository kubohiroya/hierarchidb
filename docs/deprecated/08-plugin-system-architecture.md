...
```typescript
// packages/ui-core/src/plugin-loader/lifecycle-plugin-definition.ts
...
### ✅ 完了した実装
1. **UIPluginDefinition インターフェース** - `packages/ui-core/src/plugins/lifecycle-plugin-definition.ts`
...
│       ├── lifecycle-plugin-definition.ts          # ✅ 標準化インターフェース
│       ├── registry/         # ✅ プラグイン登録管理
