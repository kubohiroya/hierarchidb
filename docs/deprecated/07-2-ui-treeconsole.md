...
| references/eria-cartograph/app0/src/features/tree-console/types/openstreetmap-type.ts | コンソール各部のProps/NodeInfo型など型定義の集約。 |
...
- **TreeConsoleToolbar_Deprecated** - 完全な見た目の再現、全ボタングループ、設定ポッパー
