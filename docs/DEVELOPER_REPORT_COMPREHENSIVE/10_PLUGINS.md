...
## Chapter 30: プラグイン管理システム (Plugin Management System) ⭐️⭐️⭐️⭐️⭐️

### 30.1 プラグイン自動検出システム (Plugin Auto-Discovery System)

#### 30.1.1 Package.jsonベースの自動検出
...
// packages/plugin-loader-plugin/styler-plugin/package.json
{
  ...
  "dependencies": {
    "@hierarchidb/spreadsheet-plugin": "workspace:*"
  },
  "hierarchidb": {
    "plugin": {
...
| ファイル | 役割 |
|---------|------|
| packages/plugin/*/package.json | 各プラグインのメタデータ |
