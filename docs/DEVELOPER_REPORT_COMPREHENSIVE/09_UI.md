...
## Chapter 25: TreeTypes Console UI (TreeTypes Console UI) ⭐️⭐️⭐️⭐️⭐️
...
graph TB
    subgraph "TreeConsole Main"
        ...
        TreeState["TreeTypes State Management"]
    ...
    subgraph "Main Components"
        TreeTable["Virtual TreeTypes Table"]
...
### 25.2 仮想化Tree Table実装 (Virtualized TreeTypes Table Implementation)
...
graph TB
    subgraph "Plugin UI Framework"
        PluginRegistryImpl["UI Plugin Registry"]
    ...
    class PluginRegistryImpl,ComponentFactory,ThemeProvider framework
