...
/**
 * 🟡 Preview state for real-time updates
 */
...
export interface StyleMapDB {
  ...
  // Working copy operations
  saveWorkingCopy(workingCopy: StyleMapWorkingCopy): Promise<void>;
...
/**
 * 🟡 StyleMap Preview component props
 */
