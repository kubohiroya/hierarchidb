...
- Aggregate legacy `BuildProgressEvent` values are not generated by the session/manager layer and are not converted into task progress. Removal of the remaining legacy type exports is handled separately after all runtime consumers have migrated.
