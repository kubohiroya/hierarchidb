...
exports.PluginExtensionRegistry = void 0;
/**
 ...
 * ```
 */
var PluginExtensionRegistry = /** @class */ (function () {
    function PluginExtensionRegistry() {
     ...
     */
    PluginExtensionRegistry.prototype.register = function (extension) {
     ...
     * ```
     */
    PluginExtensionRegistry.prototype.unregister = function (nodeType) {
     ...
     * ```
     */
    PluginExtensionRegistry.prototype.getExtension = function (nodeType) {
     ...
     */
    PluginExtensionRegistry.prototype.invokeMethod = function (nodeType, methodName) {
        var args = [];
     ...
     * ```
     */
    PluginExtensionRegistry.prototype.hasMethod = function (nodeType, methodName) {
     ...
     * ```
     */
    PluginExtensionRegistry.prototype.getAvailableMethods = function (nodeType) {
        var extension = this.getExtension(nodeType);
     ...
     * ```
     */
    PluginExtensionRegistry.prototype.getAllExtensions = function () {
        return Array.from(this.extensions.values());
    };
    return PluginExtensionRegistry;
}());
exports.PluginExtensionRegistry = PluginExtensionRegistry;
