/**
 * Node16-friendly type declarations for react-transition-group.
 *
 * These definitions mirror the upstream @types package but avoid relative
 * imports that break under Node16 module resolution.
 */
