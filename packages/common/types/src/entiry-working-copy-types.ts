 ...
 */
export type PeerEntityWorkingCopy<T extends PeerEntity = PeerEntity> = T &
  EntityWorkingCopyProperties;

/**
 * Working copy for GroupEntity
 */
export type GroupEntityWorkingCopy<T extends GroupEntity = GroupEntity> = T &
  EntityWorkingCopyProperties;

/**
 * Working copy for RelationalEntity
 */
export type RelationalEntityWorkingCopy<T extends RelationalEntity = RelationalEntity> = T &
  EntityWorkingCopyProperties & {
 ...
 */
export type EntiryWorkingCopyTypes =
