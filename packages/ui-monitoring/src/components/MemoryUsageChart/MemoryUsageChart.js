...
export const MemoryUsageChart = ({
  ...
  if (!isSupported) {
    return _jsx(Paper, {
      ...
      children: _jsx(Typography, {
        ...
        children: 'Memory monitoring not available',
      }),
    });
  }
    ...
    children: [
      ...
      _jsxs(Typography, {
        ...
        children: [
          ...
          ' / ',
          formatBytes(currentMemory.total),
        ],
      }),
      _jsx('br', {}),
      _jsxs(Typography, {
        variant: 'caption',
        children: ['Percentage: ', currentMemory.percentage.toFixed(1), '%'],
      }),
      _jsx('br', {}),
      _jsxs(Typography, { variant: 'caption', children: ['Data points: ', dataPoints.length] }),
      dataPoints.length > 0 &&
        _jsxs(_Fragment, {
          children: [
            _jsx('br', {}),
            _jsxs(Typography, {
              ...
              children: [
                'Time range: ',
                formatTime(dataPoints[0]?.timestamp || 0),
                ' - ',
  ...
  return _jsx(Tooltip, {
    ...
    placement: 'top',
    children: _jsxs(ChartContainer, {
      sx: { width, height, cursor: 'help' },
      children: [
        _jsx('canvas', {
          ref: canvasRef,
          style: {
        ...
        _jsx(Box, {
          ...
          children: _jsxs(Typography, {
            ...
            children: [currentMemory.percentage.toFixed(0), '%'],
          }),
        }),
      ],
    }),
