...
```bash
# Install the plugin
pnpm add @hierarchidb/plugin-stylemap-plugin
...
import { StyleMapDefinition } from '@hierarchidb/plugin-stylemap-plugin';
...
```typescript
import { createStyleMap } from '@hierarchidb/plugin-stylemap-plugin';
...
```typescript
import { StyleMapDialog, StyleMapImport } from '@hierarchidb/plugin-stylemap-plugin';
...
import { StyleMapAdvancedService } from '@hierarchidb/plugin-stylemap-plugin';
