  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        {t('basicInfo.description', 'Enter the basic information for your stylemap. This will help organize and identify your map style configuration.')}
      </Typography>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <TextField
            ...
            error={!!nameError}
            helperText={nameError || t('basicInfo.name.hint', 'Enter a descriptive name for this stylemap')}
            disabled={disabled}
        ...
        <Grid item xs={12}>
          <TextField
            ...
            helperText={descriptionError || t('basicInfo.description.hint', 'Optional description of what this stylemap visualizes')}
            disabled={disabled}
        ...
        <Grid item xs={12}>
          ...
          <CategorySelector
            ...
            placeholder={t('basicInfo.category.placeholder', 'Select a stylemap category')}
            disabled={disabled}
          />
          {categoryError && (
          ...
          <Typography variant="caption" color="text.secondary" sx={{ mt: 0.5, display: 'block' }}>
            {t('basicInfo.category.hint', 'Choose a category that best describes this stylemap type')}
          </Typography>
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          />
          <Typography variant="caption" color="text.secondary" sx={{ mt: 0.5, display: 'block' }}>
            {t('basicInfo.tags.hint', 'Add tags to make this stylemap easier to find and organize')}
          </Typography>
        </Grid>
      </Grid>
    </Box>
