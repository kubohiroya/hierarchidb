...
describe('Shape Plugin Integration', () => {
  ...
  // Test data
  const mockNodeId = 'shape-plugin-node-123' as NodeId;
  // const mockEntityId = 'shape-plugin-entity-456' as EntityId;
  ...
  describe('Plugin Definition Structure', () => {
    ...
    it('should have correct metadata', () => {
      ...
      expect(metadata.description).toContain('Geographic shape-plugin data processing');
  ...
  describe('Entity Handler Basic Operations', () => {
    const mockEntityData = {
      ...
      description: 'A test geographic shape-plugin layer',
    ...
    it('should create a new shape-plugin entity', async () => {
