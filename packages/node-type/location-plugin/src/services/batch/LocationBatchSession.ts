...
export interface LocationBatchTask { taskId: string; stage: string; }

export class LocationBatchSession extends AbstractBatchSession<LocationBatchConfig, LocationBatchTask, void> {
  constructor(sessionId: string, nodeId: NodeId, config: LocationBatchConfig, private tasks: LocationBatchTask[], private sink?: (e: ProgressEvent) => void) { super(sessionId, nodeId, config); }
