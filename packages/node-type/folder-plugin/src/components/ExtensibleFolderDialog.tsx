...
const baseStepDefinition: DialogStepDefinition = {
  stepNumber: 1,
        ...
        {sortedSteps.map((step, idx) => (
          <Box
            ...
            sx={{
              padding: '8px 12px',
              borderRadius: 1,
              backgroundColor: idx === activeStepIndex ? '#2563eb' : '#e2e8f0',
              color: idx === activeStepIndex ? '#fff' : '#0f172a',
              fontWeight: 600,
            }}
          >
