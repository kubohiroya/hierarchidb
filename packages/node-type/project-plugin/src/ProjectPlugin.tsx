import type { BasePluginDefinition, TreeNode, NodeId, NodeType, EntityId, TreeId } from '@hierarchidb/common-type';
...
export const ProjectPluginDefinition: BasePluginDefinition<
  ProjectEntity,
  ProjectEntity,
  ProjectEntity & { isWorkingCopy: boolean; originalId: EntityId; isDirty: boolean; copiedAt: number }
> = {
  ...
  validation: {
    ...
    canUpdate: async (_node: TreeNode, entity: ProjectEntity, updates: Partial<ProjectEntity>, _context: any) => {
    ...
    canMove: async (_node: TreeNode, _entity: ProjectEntity, _newParentNode: TreeNode, _context: any) => {
