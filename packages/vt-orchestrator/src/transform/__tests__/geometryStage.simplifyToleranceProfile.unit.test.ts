...
import { resolveSimplifyToleranceProfile } from '../createGeometryStageHandler/helpers/resolveSimplifyToleranceProfile.js';

const createBaseGeometryStageConfig = (): GeometryConfig => ({
...
describe('geometry stage resolveSimplifyToleranceProfile', () => {
  it('uses base geometry-stage values when admin-level config is not provided', () => {
    const config = createBaseGeometryStageConfig();
