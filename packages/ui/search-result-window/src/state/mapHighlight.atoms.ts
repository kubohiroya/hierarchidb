...
import type { MapHighlightStyles } from '~/types/index';
...
/**
 */
export const setSearchMatchedNodesAtom = atom(null, (_get: any, set: any, nodeIds: NodeId[]) => {
  set(searchMatchedNodeIdsAtom, new Set(nodeIds));
});

/**
 */
export const setHighlightedNodesAtom = atom(null, (_get: any, set: any, nodeIds: NodeId[]) => {
  set(highlightedNodeIdsAtom, new Set(nodeIds));
});

/**
 */
export const addSearchMatchedNodeAtom = atom(null, (get: any, set: any, nodeId: NodeId) => {
...
/**
 */
export const addHighlightedNodeAtom = atom(null, (get: any, set: any, nodeId: NodeId) => {
...
/**
 */
export const removeSearchMatchedNodeAtom = atom(null, (get: any, set: any, nodeId: NodeId) => {
  const current = get(searchMatchedNodeIdsAtom);
  const updated = new Set(current);
...
/**
 */
export const removeHighlightedNodeAtom = atom(null, (get: any, set: any, nodeId: NodeId) => {
  const current = get(highlightedNodeIdsAtom);
  const updated = new Set(current);
  updated.delete(nodeId);
  set(highlightedNodeIdsAtom, updated);
...
/**
 */
export const setFocusedNodeAtom = atom(null, (_get: any, set: any, nodeId: NodeId | null) => {
...
/**
 */
export const clearAllHighlightsAtom = atom(null, (_get: any, set: any) => {
...
/**
 */
export const clearSearchMatchedAtom = atom(null, (_get: any, set: any) => {
  set(searchMatchedNodeIdsAtom, new Set());
});

/**
 */
export const clearHighlightedAtom = atom(null, (_get: any, set: any) => {
  set(highlightedNodeIdsAtom, new Set());
  set(focusedNodeIdAtom, null);
});
