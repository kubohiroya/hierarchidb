...
export interface UseBackgroundContextMenuArgs {
    ...
    onContextAction?: (action: string, node: { id: string }, options?: Record<string, unknown>) => void;
...
export function useBackgroundContextMenu(args: UseBackgroundContextMenuArgs) {
    ...
    const reorganizeLabel = translateWithFallback('treeConsole.contextMenu.reorganizeIcons', 'Reorganize Icons');
