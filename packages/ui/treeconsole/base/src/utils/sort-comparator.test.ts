...
import { createSortComparator, DEFAULT_NODE_SIZE_RESOLVER } from './sort-comparator';

/**
 * Minimal TreeNodeInUI factory for testing.
 */
function makeNode(
  overrides: Partial<TreeNodeInUI> & { name?: string; tags?: string[] }
): TreeNodeInUI {
