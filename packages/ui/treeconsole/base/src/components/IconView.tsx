...
import { CELL_GAP_PX, computeZoomLayout } from '~/utils/zoom-layout';
import { type RubberBandRect, useIconViewBackground } from './useIconViewBackground.js';
...
function DraggableIconCell({
  ...
  const dragRef = useRef<{ startX: number; startY: number; origPx: number; origPy: number } | null>(
    null
  );
