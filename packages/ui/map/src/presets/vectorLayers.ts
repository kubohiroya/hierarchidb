...
export const pointCirclePreset = (opts?: { color?: string; radius?: number; stroke?: string; strokeWidth?: number; sourceLayer?: string }): VectorTileLayerConfig => ({
...
export const lineStrokePreset = (opts?: { color?: string; width?: number; sourceLayer?: string }): VectorTileLayerConfig => ({
...
export const polygonFillPreset = (opts?: { fill?: string; outline?: string; sourceLayer?: string }): VectorTileLayerConfig => ({
