...
describe('UserAvatar Components', () => {
  beforeEach(async () => {
    ...
    const mockGetGoogleImageVariants = vi.mocked(
      (await import('./imageUtils')).getGoogleImageVariants
    );
  ...
  describe('正常系テストケース', () => {
    ...
    it('TC-02: Google profile image - Google画像URL正常表示', async () => {
      ...
      const { container } = render(
        <UserAvatar pictureUrl="https://lh3.googleusercontent.com/test=s96" name="Test User" />
      );
    ...
    it('TC-03: Gravatar fallback - Gravatar フォールバック表示', () => {
      ...
      const { container } = render(<UserAvatar email="test@example.com" name="Test User" />);
    ...
    it('TC-05: Size customization - サイズカスタマイズ', () => {
      ...
      const { container } = render(<UserAvatar name="Test User" size={60} />);
    ...
    it('TC-06: Custom styling - カスタムスタイル適用', () => {
      ...
      const { container } = render(<UserAvatar name="Test User" sx={customSx} />);
  ...
  describe('異常系テストケース', () => {
    ...
    it('TC-08: Gravatar load failure - Gravatar読み込み失敗', () => {
      ...
      const { container } = render(<UserAvatar email="nonexistent@example.com" name="Test User" />);
    ...
    it('TC-09: Empty props - 全プロパティ空', () => {
      ...
      const { container } = render(
        <UserAvatar pictureUrl={undefined} email={undefined} name={undefined} />
      );
    ...
    it('TC-10: Invalid URLs - 無効なURL', () => {
      ...
      const { container } = render(
        <UserAvatar pictureUrl="not-a-valid-url" email="test@example.com" name="Test User" />
      );
  ...
  describe('境界値テストケース', () => {
    ...
    it('TC-13: Minimum size - 最小サイズ', () => {
      ...
      const { container } = render(<UserAvatar name="Test" size={1} />);
    ...
    it('TC-14: Maximum size - 最大サイズ', () => {
      ...
      const { container } = render(<UserAvatar name="Test" size={500} />);
    ...
    it('TC-15: Special characters in name - 特殊文字名前', () => {
      ...
      const { container } = render(<UserAvatar name="José María" />);
