...
import type { BuildProgress, BuildSessionStatus, BuildUnifiedProgressInfo } from '@hierarchidb/batch-api';
...
export const toBuildSessionStatusFromUnifiedProgress = ({
  ...
  const progress: BuildProgress = {
    ...
    skipped,
    percentage,
    taskType: info?.stage ?? fallback?.progress?.taskType,
...
export const areBuildSessionStatusesEquivalent = (
  ...
  && left.progress.taskType === right.progress.taskType
);
