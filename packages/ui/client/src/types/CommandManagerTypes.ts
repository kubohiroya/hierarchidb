...
export interface ICommandManager {
  ...
  paste(targetParentId: NodeId, trashRootNodeId: NodeId): Promise<{ pastedNodeIds: NodeId[] }>;
  pasteNodes(targetParentId: NodeId, trashRootNodeId: NodeId): Promise<{ pastedNodeIds: NodeId[] }>;
