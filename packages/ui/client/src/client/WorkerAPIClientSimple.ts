/**
 * @deprecated Use WorkerAPIClient instead. This is only for testing purposes.
 * @file WorkerAPIClientSimple.ts
 * @description Simplified WorkerAPIClient for testing only - DO NOT USE IN PRODUCTION
 * 
 * This file provides a mock implementation for testing environments.
 * For production use, always use WorkerAPIClient which connects to the actual Worker.
 */
