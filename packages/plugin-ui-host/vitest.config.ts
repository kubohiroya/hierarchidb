...
const pluginAliasEntries: Alias[] = pluginNames.flatMap((name) => {
  ...
  return [
    ...
    {
      find: `@hierarchidb/${name}-plugin/icon`,
      replacement: path.join(testingMocksRoot, 'stubs/pluginIconStub.tsx'),
    },
...
const basicInfoAliasEntries: Alias[] = [
  {
    find: '@hierarchidb/ui-plugin-basic-info',
    replacement: path.join(pluginBasicInfoRoot, 'index.ts'),
  },
  { find: '@hierarchidb/ui-plugin-basic-info/src', replacement: pluginBasicInfoRoot },
  {
    find: '@hierarchidb/runtime-worker-basic-info',
    replacement: path.join(pluginBasicInfoRoot, 'index.ts'),
  },
...
const testingAliasEntries: Alias[] = [
  {
    find: '@hierarchidb/testing-plugin-dialog-mocks',
    replacement: path.join(testingMocksRoot, 'index.ts'),
  },
  {
    find: '@hierarchidb/testing-plugin-dialog-mocks/setupPluginWorkerMock',
    replacement: path.join(testingMocksRoot, 'setupPluginWorkerMock.ts'),
  },
  {
    find: '@hierarchidb/testing-plugin-dialog-mocks/mocks',
    replacement: path.join(testingMocksRoot, 'mocks/index.ts'),
  },
  {
    find: '@hierarchidb/testing-plugin-dialog-mocks/stubs',
    replacement: path.join(testingMocksRoot, 'stubs/index.ts'),
  },
  { find: /^jotai$/, replacement: path.join(testingMocksRoot, 'stubs/jotai.ts') },
  {
    find: '@hierarchidb/plugin-registry',
    replacement: path.join(testingMocksRoot, 'stubs/pluginRegistryStub.ts'),
  },
  {
    find: '@hierarchidb/plugin-registry/dist/registry',
    replacement: path.join(testingMocksRoot, 'stubs/pluginRegistryStub.ts'),
  },
  {
    find: '@hierarchidb/plugin-registry/derivations',
    replacement: path.join(testingMocksRoot, 'stubs/pluginRegistryStub.ts'),
  },
...
const baseAliasEntries: Alias[] = [
  ...
  {
    find: 'node-fetch',
    replacement: path.resolve(__dirname, '../../app/src/virtual/node-fetch.ts'),
  },
  {
  ...
  {
    find: '@hierarchidb/map-adapter',
    replacement: path.resolve(__dirname, '../features/map-adapter/src/index.ts'),
  },
  {
