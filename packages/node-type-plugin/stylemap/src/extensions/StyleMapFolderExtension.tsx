...
import { BaseFolderPlugin } from '@hierarchidb/node-type-plugin-folder';
import type { DialogStepDefinition, ValidationResult } from '@hierarchidb/ui-plugin-base';
...
export class StyleMapFolderExtension extends BaseFolderPlugin {
  readonly pluginId = 'stylemap-folder-extension';
  ...
  protected getCreateDialogSteps(): DialogStepDefinition<any>[] {
    return [
      ...
      this.createDialogStep<{ categories?: string[] }>({
        ...
        required: false,
        order: 20,
        dependsOn: ['stylemap-folder-extension-style-config'],
      }),
    ];
  }
