...
export interface HybridFilterConfig {
  ...
  // Step 2: Regular shape aspect ratio
  ...
  // Step 3: Simple shape vertex threshold
  simpleShapeVertexThreshold: number; // Max vertices to consider shape as simple (default: 50)

  // Step 4: Elongated simple shape correction
