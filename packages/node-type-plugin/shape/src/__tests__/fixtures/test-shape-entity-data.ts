/**
 * @file test-shape-entity-data.ts
 ...
 */
export const TEST_NODE_ID = 'test-shape-node-jpu-deu-usa' as NodeId;
export const TEST_ENTITY_ID = 'test-shape-entity-jpu-deu-usa' as EntityId;
...
export function createTestShapeEntityJapanOnly(): ShapeEntity {
  ...
  return {
    ...baseEntity,
    id: 'test-shape-entity-jpn-only' as EntityId,
    nodeId: 'test-shape-node-jpn-only' as NodeId,
