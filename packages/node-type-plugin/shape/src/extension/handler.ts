 ...
 * functionality while inheriting basic folder operations.
 */
 ...
 * Combines folder functionality with Shape-specific operations
 */
  ...
  implements BaseEntityExtension<FolderEntity, ShapeEntity>
{
  ...
  async getExtendedData(nodeId: NodeId): Promise<Partial<ShapeEntity>> {
    try {
      ...
      // Return Shape-specific fields (excluding folder fields)
      return {
