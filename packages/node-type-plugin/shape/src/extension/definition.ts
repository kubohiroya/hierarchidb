 ...
 * adding geographic shape data functionality while inheriting basic name/description fields.
 *
 * Extension Hierarchy:
 ...
 * Extends the Folder plugin with geographic shape data functionality
 */
export const ShapeExtension = {
  ...
  // Step 1 (Name/Description) is automatically inherited from folder
  extendedSteps: [
    {
      stepNumber: 2,
      title: 'Data Source',
  ...
  extendedValidation: {
    ...
    chainMode: 'all',
    mergeStrategy: 'append', // Append to folder's base validation
  },
};
