...
import type { NodeType, NodeId, TreeNode } from '@hierarchidb/common-core';
import type { NodeTypeDefinition, NodeLifecycleHooks, IconDefinition } from '@hierarchidb/common-core';
import { validateNodeName, validateNodeDescription } from '@hierarchidb/common-core';
...
const baseMapIcon: IconDefinition = {
  ...
  description:
    'Base Map - Configure and manage map layers with various styles and visualization options',
