...
/**
 * Extension point for folder dialogs
 */
...
/**
 * Extension point for folder entity handling
 */
export interface FolderEntityExtension extends BaseEntityExtension<FolderEntity> {
  /**
   * Additional fields to store with folder entity
   */
...
/**
 * Complete folder extension configuration
 */
...
/**
 * Registry for folder extensions
 */
export class FolderExtensionRegistry {
  ...
  buildExtensionConfig(): PluginExtensionConfig {
    ...
    const config: PluginExtensionConfig = {
      ...
      metadata: {
        id: 'folder-extension-combined',
        name: 'Combined Folder Extensions',
        version: '1.0.0',
        description: 'Combined configuration from all folder extensions',
  ...
  /**
   * Create an ExtendableNodeTypeDefinition from the base folder definition and extensions
   */
...
/**
 * Helper function to create a folder extension
 */
