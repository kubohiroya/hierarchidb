...
/**
 * Base class for plugins that extend the folder plugin
 */
export abstract class BaseFolderPlugin {
  ...
  /**
   * Other folder extensions this plugin depends on
   */
  readonly dependencies: string[] = [];

  /**
   * Initialize the plugin and register with folder extension system
   */
  ...
  /**
   * Create the folder extension configuration
   */
  ...
  /**
   * Lifecycle hook: called after folder creation
   */
  ...
  /**
   * Lifecycle hook: called before folder update
   */
  ...
  /**
   * Lifecycle hook: called after folder update
   */
  ...
  /**
   * Lifecycle hook: called before folder deletion
   */
