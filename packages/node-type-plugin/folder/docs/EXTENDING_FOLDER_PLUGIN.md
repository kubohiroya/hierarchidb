...
```typescript
// packages/node-type-plugin/stylemap/src/extension/definition.ts
...
```typescript
// packages/node-type-plugin/stylemap/src/entities/StyleMapEntity.ts

import type { FolderEntity } from '@hierarchidb/node-type-plugin-folder';
...
```typescript
// packages/node-type-plugin/stylemap/src/handlers/StyleMapEntityHandler.ts

import { FolderEntityHandler } from '@hierarchidb/node-type-plugin-folder';
...
```typescript
// packages/node-type-plugin/stylemap/src/steps/FileUploadStep.tsx
...
```typescript
// packages/node-type-plugin/stylemap/src/index.ts
