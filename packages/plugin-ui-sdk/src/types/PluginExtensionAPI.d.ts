 ...
 * ```
 */
export interface PluginExtensionAPI<TMethods extends Record<string, WorkerAPIMethod> = Record<string, WorkerAPIMethod>> {
 ...
 * ```
 */
export type InvokeResult<T extends PluginExtensionAPI, M extends keyof T['methods']> = T['methods'][M] extends (...args: APIMethodArgs) => Promise<infer R> ? R extends APIMethodReturn ? R : never : never;
/**
 ...
 * ```
 */
export declare class PluginExtensionRegistry {
     ...
     * ```
     */
    getExtension<T extends Record<string, WorkerAPIMethod> = Record<string, WorkerAPIMethod>>(nodeType: NodeType): PluginExtensionAPI<T> | undefined;
    /**
     ...
     */
    invokeMethod<TMethods extends Record<string, WorkerAPIMethod>, TMethod extends keyof TMethods, TArgs extends Parameters<TMethods[TMethod]>, TReturn extends ReturnType<TMethods[TMethod]>>(nodeType: NodeType, methodName: TMethod, ...args: TArgs): Promise<TReturn>;
    /**
...
//# sourceMappingURL=PluginExtensionAPI.d.ts.map