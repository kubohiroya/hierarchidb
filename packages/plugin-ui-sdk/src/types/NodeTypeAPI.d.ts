 ...
 */
import type { NodeId, NodeLifecycleHooks, NodeType, TreeNode, ValidationResult } from '@hierarchidb/common-types';
...
export interface NodeTypeAPI {
     ...
     */
    validateOperation(nodeType: NodeType, operation: 'create' | 'update' | 'delete' | 'move', context?: {
        parentId?: NodeId;
        targetNodeId?: NodeId;
     ...
     */
    validateNodeType(node: TreeNode): Promise<{
        valid: boolean;
        errors: string[];
    }>;
    /**
...
//# sourceMappingURL=NodeTypeAPI.d.ts.map