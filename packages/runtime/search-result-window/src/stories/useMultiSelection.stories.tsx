      ...
      <Stack spacing={3}>
        ...
        <Paper sx={{ p: 2 }}>
          ...
          <Stack direction="row" spacing={1} flexWrap="wrap">
            ...
            <Button
              variant="outlined"
              onClick={() => handleMapFocus(mockResults[0])}
            >
              Focus First Item
            </Button>
          </Stack>
        ...
        <Paper>
          ...
          <Typography variant="caption" sx={{ px: 2, color: 'text.secondary' }}>
            Click: Single select | Ctrl/Cmd+Click: Toggle | Shift+Click: Range select | Double-click: Map focus
          </Typography>
              ...
              {selectedResultItems.map((item, index) => (
                <Box key={item.nodeId}>
                  ...
                  <Typography variant="caption" color="text.secondary">
                    Path: {item.parentPath.join(' > ')} • Confidence: {Math.round(item.confidence * 100)}%
                  </Typography>
