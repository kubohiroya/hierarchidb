...
const gadmMetadata = require('@hierarchidb/runtime-fetch-metadata/output/gadm.json');
const naturalEarthMetadata = require('@hierarchidb/runtime-fetch-metadata/output/naturalearth.json');
const geoboundariesMetadata = require('@hierarchidb/runtime-fetch-metadata/output/geoboundaries.json');
const osmMetadata = require('@hierarchidb/runtime-fetch-metadata/output/osm.json');
...
// import geoboundariesMetadata from '@hierarchidb/runtime-fetch-metadata/output/geoboundaries.json';
// import osmMetadata from '@hierarchidb/runtime-fetch-metadata/output/osm.json';
