...
```bash
pnpm add @hierarchidb/runtime-base-dialog
```
...
```tsx
import { CommonDialog } from '@hierarchidb/runtime-base-dialog';
...
```tsx
import { StepperDialog, CustomFooterProps } from '@hierarchidb/runtime-base-dialog';
...
```tsx
import { useWorkingCopy } from '@hierarchidb/runtime-base-dialog';
...
1. Replace your Dialog wrapper with `CommonDialog`
