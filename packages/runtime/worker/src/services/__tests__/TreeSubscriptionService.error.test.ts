...
/**
 * TreeSubscriptionService - Error Handling & Resource Management Tests
 *
 ...
 */
describe('TreeSubscriptionService - Error Handling & Resource Management', () => {
  ...
  beforeEach(() => {
    ...
    service = new TreeSubscriptionService(mockCoreDB);
  });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      const observable = await service.subscribeNodeCommand(cmd);
