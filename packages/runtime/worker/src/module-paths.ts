// <reference path="./virtual-registry.d.ts" />
 ...
 * for the application bundle. It resolves plugin workers via the app-side
 * virtual plugin registry generated by the Vite plugin.
 */

import { pluginMapWorker } from 'virtual:plugin-registry-worker';
