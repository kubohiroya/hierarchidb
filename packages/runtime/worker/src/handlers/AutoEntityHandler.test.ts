...
describe('AutoEntityHandler', () => {
  ...
  beforeEach(async () => {
    ...
    handler = new AutoEntityHandler<TestEntity>(nodeType, 'testEntities', lifecycleManager);
  });
  ...
  describe('duplicateEntity', () => {
    ...
    it('should handle duplication errors gracefully', async () => {
      vi.spyOn(lifecycleManager, 'onNodeDuplicate').mockRejectedValue(
  ...
  describe('createWorkingCopy', () => {
    ...
    it('should handle working copy creation errors', async () => {
      vi.spyOn(lifecycleManager, 'createWorkingCopies').mockRejectedValue(
        new Error('WC creation failed')
      );
  ...
  describe('commitWorkingCopy', () => {
    ...
    it('should handle commit errors gracefully', async () => {
      vi.spyOn(lifecycleManager, 'commitWorkingCopies').mockRejectedValue(
  ...
  describe('discardWorkingCopy', () => {
    ...
    it('should handle discard errors gracefully', async () => {
      vi.spyOn(lifecycleManager, 'discardWorkingCopies').mockRejectedValue(
        new Error('Discard failed')
      );

      await expect(handler.discardWorkingCopy(nodeId, workingCopy)).rejects.toThrow(
        'Discard failed'
      );
    });
  });
