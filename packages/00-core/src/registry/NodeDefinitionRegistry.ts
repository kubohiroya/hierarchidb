...
export class NodeDefinitionRegistry
  extends BaseNodeTypeRegistry<NodeTypeDefinition<PeerEntity, GroupEntity, PeerEntity & WorkingCopyProperties>>
  implements INodeDefinitionRegistry
{
  private static instance: NodeDefinitionRegistry;
  private handlers: Map<TreeNodeType, EntityHandler<PeerEntity, GroupEntity, PeerEntity & WorkingCopyProperties>> =
    new Map();
   ...
   */
  register(_nodeType: TreeNodeType, config: NodeTypeDefinition<PeerEntity, GroupEntity, PeerEntity & WorkingCopyProperties>): void {
  ...
  >(definition: NodeTypeDefinition<TEntity, TGroupEntity, TWorkingCopy>): {
    ...
    const adaptedHandler: EntityHandler<PeerEntity, GroupEntity, PeerEntity & WorkingCopyProperties> = {
      // Entity operations
      ...
      createWorkingCopy: async (nodeId) =>
        await entityHandler.createWorkingCopy(nodeId),
    ...
    const adaptedDefinition: NodeTypeDefinition<PeerEntity, GroupEntity, PeerEntity & WorkingCopyProperties> = {
      ...definition,
