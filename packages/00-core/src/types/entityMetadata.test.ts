...
describe('EntityMetadata Type Definitions', () => {
  ...
  describe('EntityRelationship', () => {
    it('should define relationship structure', () => {
      ...
      expectTypeOf(relationship.type).toEqualTypeOf<'one-to-one' | 'one-to-many' | 'many-to-many'>();
  ...
  describe('EntityMetadata', () => {
    ...
    it('should make optional fields truly optional', () => {
      ...
      expectTypeOf(minimalMetadata.referenceManagement).toEqualTypeOf<ReferenceManagement | undefined>();
      expectTypeOf(minimalMetadata.workingCopyConfig).toEqualTypeOf<WorkingCopyConfig | undefined>();
    });
  });
