...
const LOCATION_TYPE_BASE: LocationTypeBaseConfig[] = [
  { id: 'airport' as LocationType, icon: '✈️', color: '#2196F3', descriptionKey: 'airport', estimatedCount: 28000 },
  { id: 'railway_station' as LocationType, icon: '🚂', color: '#4CAF50', descriptionKey: 'railway_station', estimatedCount: 45000 },
  { id: 'port' as LocationType, icon: '🚢', color: '#FF9800', descriptionKey: 'port', estimatedCount: 12000 },
  { id: 'government' as LocationType, icon: '🏛️', color: '#9C27B0', descriptionKey: 'government', estimatedCount: 8000 },
  { id: 'interchange' as LocationType, icon: '🛣️', color: '#607D8B', descriptionKey: 'interchange', estimatedCount: 15000 },
];
