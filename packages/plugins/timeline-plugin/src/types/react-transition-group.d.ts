// Local ambient declarations to satisfy MUI's import of 'react-transition-group/Transition'
// This bridges to the main module types. Remove when upstream/types setup covers this subpath.
