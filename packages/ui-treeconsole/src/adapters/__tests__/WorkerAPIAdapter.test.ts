...
import type { TreeChangeEvent, CommandResult } from '@hierarchidb/core';
...
describe('WorkerAPIAdapter', () => {
  ...
  describe('Mutation Operations', () => {
    ...
    it('should handle command failures properly', async () => {
      ...
      await expect(
        adapter.moveNodes(['node1'] as any, 'invalid-target' as any)
