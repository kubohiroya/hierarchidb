...
describe('EntityRegistrationService', () => {
  ...
  describe('registerEntity', () => {
    it('should register a new entity metadata', () => {
      ...
      service.registerEntity('test-node' as TreeNodeType, 'test-entity', metadata);
      
      const retrieved = service.getEntitiesByNodeType('test-node' as TreeNodeType);
    ...
    it('should register multiple entities for the same node type', () => {
      ...
      service.registerEntity('complex-node' as TreeNodeType, 'peer-entity', peerMetadata);
      service.registerEntity('complex-node' as TreeNodeType, 'group-entity', groupMetadata);

      const retrieved = service.getEntitiesByNodeType('complex-node' as TreeNodeType);
    ...
    it('should throw error for duplicate entity key', () => {
      ...
      service.registerEntity('test-node' as TreeNodeType, 'duplicate-key', metadata);
    ...
    it('should validate required metadata fields', () => {
      ...
      expect(() => {
        service.registerEntity('test-node' as TreeNodeType, 'invalid', invalidMetadata);
    ...
    it('should register relational entity with reference management', () => {
      ...
      service.registerEntity('resource-node' as TreeNodeType, 'shared-resource', relationalMetadata);
      
      const retrieved = service.getEntitiesByNodeType('resource-node' as TreeNodeType);
      expect(retrieved).toHaveLength(1);
  ...
  describe('getEntitiesByNodeType', () => {
    it('should return empty array for unregistered node type', () => {
      const result = service.getEntitiesByNodeType('unknown-node' as TreeNodeType);
    ...
    it('should return entities in registration order', () => {
      ...
      service.registerEntity('ordered-node' as TreeNodeType, 'entity1', metadata1);
      service.registerEntity('ordered-node' as TreeNodeType, 'entity2', metadata2);

      const retrieved = service.getEntitiesByNodeType('ordered-node' as TreeNodeType);
  ...
  describe('getEntityByKey', () => {
    it('should retrieve entity by key', () => {
      ...
      service.registerEntity('test-node' as TreeNodeType, 'specific-key', metadata);
  ...
  describe('getEntitiesSortedByType', () => {
    it('should return entities sorted by type for deletion (relational, group, peer)', () => {
      ...
      service.registerEntity('mixed-node' as TreeNodeType, 'peer', peerMetadata);
      service.registerEntity('mixed-node' as TreeNodeType, 'relational', relationalMetadata);
      service.registerEntity('mixed-node' as TreeNodeType, 'group', groupMetadata);

      const sorted = service.getEntitiesSortedByType('mixed-node' as TreeNodeType, 'delete');
    ...
    it('should return entities sorted by type for commit (peer, group, relational)', () => {
      ...
      service.registerEntity('commit-node' as TreeNodeType, 'relational', relationalMetadata);
      service.registerEntity('commit-node' as TreeNodeType, 'peer', peerMetadata);

      const sorted = service.getEntitiesSortedByType('commit-node' as TreeNodeType, 'commit');
  ...
  describe('clear', () => {
    it('should clear all registrations', () => {
      ...
      service.registerEntity('test-node' as TreeNodeType, 'test-key', metadata);
      expect(service.getEntityByKey('test-key')).toBeDefined();

      service.clear();
      
      expect(service.getEntityByKey('test-key')).toBeUndefined();
      expect(service.getEntitiesByNodeType('test-node' as TreeNodeType)).toEqual([]);
    });
  });
});