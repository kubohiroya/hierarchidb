...
import type { CallBackProps as ReactJoyrideCallBackProps, Step as ReactJoyrideStep } from 'react-joyride';
...
export interface GenericGuidedTourProps {
  run: boolean;
  onFinish?: () => void;
  steps: ReactJoyrideStep[];
  tourType?: string;
  callback?: (data: ReactJoyrideCallBackProps) => void;
  stepIndex?: number;
}
...
export const GenericGuidedTour = ({
  ...
  const handleJoyrideCallback = useCallback(
    (data: ReactJoyrideCallBackProps) => {
    ...
    ({
      ...
      return (
        ...
        >
          ...
          {/* Always use custom footer for consistent layout */}
