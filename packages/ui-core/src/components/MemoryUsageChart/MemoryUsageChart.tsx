...
export const MemoryUsageChart: React.FC<MemoryUsageChartProps> = ({
  ...
  }, [memoryData, theme, categoryColors, warningThreshold, criticalThreshold, showGrid, maxDataPoints]);
    ...
    <Paper sx={{ width, height: getComponentHeight(), p: 2, position: 'relative' }}>
      ...
      <Box sx={{ mb: variant === 'compact' ? 1 : 2 }}>
        <Typography variant="body2" sx={{ 
          color: memoryData.percentage > criticalThreshold * 100 ? 'error.main' :
                 memoryData.percentage > warningThreshold * 100 ? 'warning.main' : 'text.primary'
        }}>
