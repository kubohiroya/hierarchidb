...
export interface PluginRegistryAPI {
   ...
   * ```
   */
  isSupportedNodeType(nodeType: TreeNodeType): Promise<boolean>;
   ...
   * ```
   */
  getNodeDefinition(nodeType: TreeNodeType): Promise<CoreNodeDefinition | undefined>;
   ...
   */
  unregisterPlugin(nodeType: TreeNodeType): Promise<{
    success: boolean;
   ...
   */
  reloadPlugin(nodeType: TreeNodeType, definition: CoreNodeDefinition): Promise<{
    success: boolean;
   ...
   */
  validatePluginDefinition(definition: CoreNodeDefinition): Promise<ValidationResult & {
    warnings?: string[];
   ...
   */
  checkPluginCompatibility(nodeType: TreeNodeType): Promise<{
    compatible: boolean;
    version: string;
   ...
   */
  getSupportedOperations(nodeType: TreeNodeType): Promise<Array<'create' | 'read' | 'update' | 'delete' | 'move' | 'copy'>>;
   ...
   */
  supportsChildren(nodeType: TreeNodeType): Promise<boolean>;
  ...
  getNodeTypeDefinition(nodeType: TreeNodeType): Promise<CoreNodeDefinition | undefined>;
   ...
   * ```
   */
  getExtension<T = any>(nodeType: TreeNodeType): Promise<T>;
   ...
   * ```
   */
  registerExtension(nodeType: TreeNodeType, api: any): Promise<void>;
}
