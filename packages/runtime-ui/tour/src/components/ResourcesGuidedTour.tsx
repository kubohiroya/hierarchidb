...
export const ResourcesGuidedTour: React.FC<ResourcesGuidedTourProps> = ({ run, onFinish }) => {
      ...
      content: (
        <div style={{ textAlign: 'center', padding: '20px', minWidth: '400px' }}>
          ...
          <p style={{ marginBottom: '16px' }}>
            Resources contain your data that can be visualized and analyzed. You can import various
            data formats and organize them hierarchically.
          </p>
          <p>
            This guided tour will help you understand how to manage and utilize your resources
            effectively.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>
            Use this toggle to switch between different tree views. You're currently viewing the
            Resources tree.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>
            Resources are organized in a hierarchical structure. The breadcrumb shows your current
            location.
          </p>
          <p style={{ marginTop: 8 }}>• Navigate by clicking breadcrumb items</p>
          <p>• Access context menus for quick actions</p>
        </div>
      ),
      placement: 'bottom',
      disableBeacon: true,
    },
    {
      ...
      content: (
        <div>
          ...
          <p>The toolbar provides essential tools for managing your resources:</p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>Powerful import/export capabilities:</p>
          <ul style={{ textAlign: 'left', paddingLeft: 20 }}>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>The table view displays your resources with:</p>
          <ul style={{ textAlign: 'left', paddingLeft: 20 }}>
  ...
  return <GenericGuidedTour run={run} onFinish={onFinish} steps={steps} tourType="resourcesTour" />;
};
