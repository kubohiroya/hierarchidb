...
export interface ITreeNodesDB {
  ...
  createNodeTx(
    ...
    src: Pick<TreeNodeEntity, "name" | "type"> &
      Partial<
        Pick<TreeNodeEntity, "id" | "description" | "isDraft" | "workingCopyOf">
      >,
  ): Promise<TreeNodeEntityWithChildren>;
   ...
   */
  getTrashRootNodeId(rootNodeType: TreeNodeType): NodeId;
   ...
   * @returns The corresponding trash root node ID
   */
  getTrashRootNodeIdSync?(rootNodeType: TreeNodeType): NodeId;
