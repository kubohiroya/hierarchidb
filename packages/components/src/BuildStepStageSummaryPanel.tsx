...
const BuildStepStageSummaryPanelComponent: FC<BuildStepStageSummaryPanelProps> = ({
  title,
  description,
  progress,
  taskCount,
...
export const BuildStepStageSummaryPanel = memo(BuildStepStageSummaryPanelComponent);
