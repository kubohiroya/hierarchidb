/**
 * @hierarchidb/plugin-import-export-plugin
 *
...
export { ImportExportPluginRegistry, importExportPluginRegistry } from './registry/PluginAutoRegistration';
export { 
  IMPORT_EXPORT_PLUGIN_METADATA, 
  PLUGIN_DEFINITIONS 
} from './registry/PluginAutoRegistration';
// TODO: Fix PluginMetadata type conflict - there are two different interfaces
...
export const PLUGIN_NAME = '@hierarchidb/feature-import-export-plugin-plugin';
