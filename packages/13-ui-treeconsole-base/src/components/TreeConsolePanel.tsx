...
import { TreeConsoleBreadcrumb } from '@hierarchidb/12-ui-treeconsole-breadcrumb';
...
import type { SpeedDialActionType } from '@hierarchidb/12-ui-treeconsole-speeddial';
