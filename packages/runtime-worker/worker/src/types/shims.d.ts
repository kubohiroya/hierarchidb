declare module '@hierarchidb/feature-registry' {
  export class FeatureRegistry { register(_: any): void; startAll(): Promise<void>; }
}
declare module '@hierarchidb/tag' {
  export type TagDBPort = any;
  export class TagService { static getSingleton(_: any): Promise<any>; }
  export const featureDefinition: any;
}
declare module '@hierarchidb/import-export' {
  export type ImportExportDBPort = any;
  export class ImportExportService { static getSingleton(_: any): Promise<any>; }
  export function enableAllImporters(): void;
  export function enableAllExporters(): void;
  export const featureDefinition: any;
}
declare module '@hierarchidb/tabular' { export const featureDefinition: any; }
...
declare module '@hierarchidb/compute' { export const featureDefinition: any; }
declare module '@hierarchidb/batch' { export const featureDefinition: any; }
