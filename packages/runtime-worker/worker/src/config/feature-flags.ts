...
export const FEATURE_FLAGS = {
  ...
  get WORKER_WC_COMMIT_V2() { return flagOn('WORKER_WC_COMMIT_V2'); },
  get WORKER_TRASH_USE_HOLDER() { return flagOn('WORKER_TRASH_USE_HOLDER'); },
  ...
  get WORKER_ENTITY_UNIFIED() { return flagOn('WORKER_ENTITY_UNIFIED'); },
