...
import { SimplePeerEntityHandler } from './SimpleEntityHandler';

describe('PeerEntityHandler', () => {
  let db: Dexie;
  let handler: SimplePeerEntityHandler;
  ...
  beforeEach(async () => {
    ...
    handler = new SimplePeerEntityHandler(db, 'entities', 'workingCopies', 'subEntities');
  });
