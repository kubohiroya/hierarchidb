...
const peerDbLoaders = new Map<NodeType, PeerDbLoader>([
  [toNodeType('folder'), createPeerDbLoader('@hierarchidb/folder-plugin/src/worker/folderEntitiesDB', 'FolderEntitiesDB')],
  [toNodeType('route'), createPeerDbLoader('@hierarchidb/route-plugin/src/worker/routeEntitiesDB', 'RouteEntitiesDB')],
  [toNodeType('resolver'), createPeerDbLoader('@hierarchidb/resolver-plugin/src/worker/resolverEntitiesDB', 'ResolverEntitiesDB')],
  [toNodeType('shape'), createPeerDbLoader('@hierarchidb/shape-plugin/src/worker/shapeEntitiesDB', 'ShapeEntitiesDB')],
  [toNodeType('location'), createPeerDbLoader('@hierarchidb/location-plugin/src/worker/locationEntitiesDB', 'LocationEntitiesDB')],
  [toNodeType('spreadsheet'), createPeerDbLoader('@hierarchidb/spreadsheet-plugin/src/worker/spreadsheetEntitiesDB', 'SpreadsheetEntitiesDB')],
  [toNodeType('styler'), createPeerDbLoader('@hierarchidb/styler-plugin/src/worker/stylerEntitiesDB', 'StylerEntitiesDB')],
  [toNodeType('basemap'), createPeerDbLoader('@hierarchidb/basemap-plugin/src/worker/basemapEntitiesDB', 'BasemapEntitiesDB')],
]);
