vk:task id=epic-wc-trash-unification status=in_progress priority=P0 labels=epic,draft,trash,docs,ui

# エピック: Draft/Trash 統合ロードマップ

## ゴール
- Draft と Trash の内部表現を holder+child へ統一し、ポリシーC・単一WC共有・一意エンコード・Tx一貫性を確立する。
...
## トラッキング
- 依存: `docs/adr/adr-single-draft-per-target.md`, `docs/adr/adr-block-move-delete-when-wc-in-subtree.md`, `docs/adr/adr-draft-trash-unification.md`
