...
- update: 2026-02-17 17:10 JST #344 検証結果: `pnpm -w turbo run typecheck --filter @hierarchidb/app --filter @hierarchidb/shape-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run test --filter @hierarchidb/shape-plugin -- --run src/ui/__tests__/hooks/unit/useShapeBuildTasks.unit.test.tsx src/ui/__tests__/hooks/integration/buildSessionStartup.integration.test.tsx` exit 0、`pnpm -w turbo run test --filter @hierarchidb/route-plugin -- --run src/ui/components/__tests__/unit/RouteBatchProgress.unit.test.tsx` exit 0（turbo cache hit）、`pnpm -w turbo run test --filter @hierarchidb/location-plugin -- --run src/common/hooks/__tests__/unit/useLocationProgress.auth.unit.test.ts` exit 0。
...
- update: 2026-02-17 15:59 JST #340 まとめ検証を実施。`pnpm -w turbo run typecheck --filter @hierarchidb/app --filter @hierarchidb/ui-worker-client --filter @hierarchidb/worker-api --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/ui-memory --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/app --filter @hierarchidb/ui-worker-client --filter @hierarchidb/worker-api --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/ui-memory --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0。
...
- update: 2026-02-17 15:46 JST #340 追加検証: `pnpm -w turbo run typecheck --filter @hierarchidb/app --filter @hierarchidb/ui-memory --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/app --filter @hierarchidb/ui-memory --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0。
...
- update: 2026-02-17 15:44 JST #340 検証結果: `pnpm -w turbo run typecheck --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/app --only --output-logs errors-only` exit 0。
...
- update: 2026-02-17 15:35 JST #340 検証結果: `pnpm -w turbo run typecheck --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/ui-worker-client --filter @hierarchidb/worker-api --only --output-logs errors-only` exit 0。
...
- update: 2026-02-17 15:30 JST #340 `@hierarchidb/ui-worker-client` で `BuildWorkerBridge` を deprecated `Batch*` メソッド除外型へ変更し、`getBuildWorkerBridge()` を追加。`@hierarchidb/ui-batch-progress` の `useBuildSessionMutation` 実装は canonical bridge（`cancelQueuedBuildSession`）のみを呼ぶよう整理。
- update: 2026-02-17 15:30 JST #340 検証結果: `pnpm -w turbo run build --filter @hierarchidb/ui-worker-client --filter @hierarchidb/worker-api --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/ui-batch-progress --only --output-logs errors-only` exit 0。
...
- update: 2026-02-17 16:22 JST #340 Batch→Build 用語統一を継続。`@hierarchidb/batch-api` を Build 正準型へ再編（`BuildStatus` / `BuildSessionStatus` / `BuildProgress*` を一次定義化し、`Batch*` は deprecated alias 化）。`progress-types.ts` も `BuildStage` 正準に更新。
...
- update: 2026-02-17 16:22 JST #340 追従修正として `plugins/location-plugin/src/common/hooks/useLocationProgress.ts` と `plugins/route-plugin/src/ui/hooks/useRouteBatchProgress.ts` / `RouteBatchProgressBar.tsx` の型参照を `UnifiedProgressInfo` から `BuildUnifiedProgressInfo` に切替。検証: `pnpm -w turbo run typecheck --filter @hierarchidb/batch-api --filter @hierarchidb/batch --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/batch-api --filter @hierarchidb/batch --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only` exit 0（既知 warning のみ）。
...
- update: 2026-02-17 14:35 JST #340 `@hierarchidb/ui-batch-progress` に `useBuildSessionMutation` alias を追加し、`@hierarchidb/ui-worker-client` の runtime export registry/wiring で `createBuildManager` を正準化（`createBatchManager` は互換入力として受理）。`@hierarchidb/batch` では `BuildPersistence`/`UnifiedBuildSession` の型再エクスポートを追加。
- update: 2026-02-17 14:35 JST #340 検証結果: `pnpm -w turbo run typecheck --filter @hierarchidb/batch --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/ui-worker-client --filter @hierarchidb/route-plugin --only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/location-plugin --filter @hierarchidb/shape-plugin --only` exit 0。
...
- update: 2026-02-17 14:10 JST #340 ドキュメント/テスト語彙を更新（`docs/UNIFIED_BATCH_CONTROL_API.md`, `plugins/README.md`, `plugins/resolver-plugin/README.md`, `plugins/location-plugin/batch-processing-ja.md`, `plugins/shape-plugin/docs/BATCH_PROCESSING_NOTIFICATION.md`, `app/src/contexts/__tests__/shape-workerprovider.full-flow.test.tsx`, `plugins/shape-plugin/src/e2e/shape-test-worker.entry.ts`, `plugins/shape-plugin/src/__tests__/wfl/shape-build-resume-after-pause.wfl.test.ts`, location/treeconsoleテストshims）。
...
- update: 2026-02-17 13:56 JST #340 core語彙置換を継続。`@hierarchidb/batch-api` の `IBuildSessionManager` を正準インターフェース化し、Buildメソッド（`startBuildSession/pauseBuildSession/resumeBuildSession/getBuildSessionStatus/onBuildProgress`）を必須化。Batchメソッドは deprecated 互換メソッドとして同居。
- update: 2026-02-17 13:56 JST #340 `packages/batch/src/manager/BaseBatchSessionManager.ts` / `UnifiedBatchManagerBase.ts` を更新し、Build正準メソッドを実装、Batchメソッドは委譲ラッパー化。`plugins/route-plugin/src/common/orchestrator/RouteBatchOrchestrationService.ts` は起動経路を `startBuildSession` に変更。`packages/batch-api/src/taskStatus.ts` に `mapProgressPhaseToBuildStatus` を追加（旧 `mapProgressPhaseToBatchStatus` は deprecated alias）。
- update: 2026-02-17 13:56 JST #340 検証結果: `pnpm -w turbo run build --filter @hierarchidb/batch-api --filter @hierarchidb/batch --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/batch-api --filter @hierarchidb/batch --filter @hierarchidb/route-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/route-plugin --only --output-logs errors-only` exit 0。
- blocked: 2026-02-17 13:56 JST #340 初回 `pnpm -w turbo run typecheck --filter @hierarchidb/batch-api --filter @hierarchidb/batch --filter @hierarchidb/route-plugin --only --output-logs errors-only` は route-plugin が旧 `@hierarchidb/batch` の未ビルドd.tsを参照し `startBuildSession` 不在で exit 2。`@hierarchidb/batch-api` / `@hierarchidb/batch` build 後に再実行して解消。
...
- update: 2026-02-17 13:39 JST #340 検証結果: `pnpm -w turbo run typecheck --filter @hierarchidb/route-plugin --filter @hierarchidb/shape-plugin --filter @hierarchidb/ui-batch-progress --only --output-logs errors-only` exit 0、`pnpm -w turbo run build --filter @hierarchidb/route-plugin --filter @hierarchidb/shape-plugin --filter @hierarchidb/ui-batch-progress --only --output-logs errors-only` exit 0。
- update: 2026-02-17 13:34 JST #340 用語置換を追加実施。`@hierarchidb/session-coordinator` に `TabSessionCoordinator` alias export を追加し、`@hierarchidb/ui-session-coordinator` / `@hierarchidb/ui-worker-client` / `@hierarchidb/worker-api` / `app/src/worker-runtime/workerBootstrap.ts` / `@hierarchidb/ui-batch-progress` / `plugins/shape-plugin` の Build正準呼称（`*Build*` 優先）へ置換。Batch系メソッドは互換aliasとして維持。
...
- update: 2026-02-17 13:34 JST #340 検証結果: `pnpm -w turbo run build --filter @hierarchidb/session-coordinator --filter @hierarchidb/ui-session-coordinator --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --only --output-logs errors-only` exit 0、`pnpm -w turbo run typecheck --filter @hierarchidb/session-coordinator --filter @hierarchidb/ui-session-coordinator --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/shape-plugin --only --output-logs errors-only` exit 0。
- blocked: 2026-02-17 13:34 JST #340 `pnpm -w turbo run typecheck --filter @hierarchidb/session-coordinator --filter @hierarchidb/ui-session-coordinator --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/app --filter @hierarchidb/shape-plugin --only --output-logs errors-only` は差分外既知ブロッカー `app/src/worker-runtime/client.ts:262` (`rawWorkerInstance` 未定義) により exit 1。加えて依存込み実行では `@hierarchidb/plugin-service-api` の `@types/react` 重複（TS2300）で exit 2。
...
- update: 2026-02-17 13:02 JST #340 パッケージ単位リファクタを実施。`BaseBatchSessionManager` を `packages/batch/src/manager/BaseBatchSessionManager.ts` へ移管し、`@hierarchidb/batch-runtime-services` は `@hierarchidb/batch` からの再エクスポートへ縮退。`plugins/route-plugin` の batch 依存 import を `@hierarchidb/batch` へ切替、`batch-runtime-services` 参照を package 設定から削減。
- update: 2026-02-17 13:02 JST #340 `packages/runtime-worker/src/services/buildSessionBroadcast.ts` を `session-coordinator` 非依存のローカル BroadcastChannel 実装へ置換し、`packages/runtime-worker/package.json` の `@hierarchidb/session-coordinator` 依存と turbo build 依存（`@hierarchidb/batch-runtime-services#build`）を削除。
...
- blocked: 2026-02-17 13:02 JST #340 `pnpm -w turbo run typecheck --filter @hierarchidb/batch --filter @hierarchidb/batch-runtime-services --filter @hierarchidb/runtime-worker --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/route-plugin --filter @hierarchidb/shape-plugin --output-logs errors-only` は差分外既知ブロッカー `@hierarchidb/plugin-service-api` の `@types/react` 重複（TS2300 `ElementType` / `LibraryManagedAttributes`）で exit 2。
- update: 2026-02-17 13:02 JST #340 個別検証（Turbo `--only`）は成功: `@hierarchidb/batch` typecheck exit 0, `@hierarchidb/batch-runtime-services` typecheck exit 0, `@hierarchidb/runtime-worker` typecheck exit 0, `@hierarchidb/ui-batch-progress` build+typecheck exit 0, `@hierarchidb/route-plugin` typecheck exit 0, `@hierarchidb/shape-plugin` typecheck exit 0。
...
- blocked: 2026-02-17 12:28 JST #340 `pnpm -w turbo run typecheck --filter @hierarchidb/components --filter @hierarchidb/shape-plugin --output-logs errors-only` は差分外既知ブロッカー `@hierarchidb/batch-runtime-services` の `@types/react` 重複（TS2300: `ElementType` / `LibraryManagedAttributes`）で exit 2。`pnpm -w turbo run typecheck --filter @hierarchidb/components --output-logs errors-only` は exit 0。
...
- update: 2026-02-17 11:57 JST #340 ドキュメント整理状況を監査し、旧パス参照が実運用ドキュメントから解消済みであることを確認（残存は `TASKS.md` の履歴ログのみ）。`packages/batch-session-ports` に `BuildSessionControlPort`（subscribe/start/stop/cancelQueued/nextStage）と関連型を追加し、README を責務中心に再整理。
...
- update: 2026-02-17 12:07 JST #340 `pnpm -w turbo run typecheck --filter @hierarchidb/batch-session-ports --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --output-logs errors-only` は exit 0。
- blocked: 2026-02-17 12:08 JST #340 `pnpm -w turbo run typecheck --filter @hierarchidb/batch-session-ports --filter @hierarchidb/worker-api --filter @hierarchidb/ui-worker-client --filter @hierarchidb/app --filter @hierarchidb/shape-plugin --output-logs errors-only` は差分外既知ブロッカー `@hierarchidb/batch-runtime-services` の `@types/react` 重複（TS2300: `ElementType` / `LibraryManagedAttributes`）で exit 2。
...
- done: 2026-02-17 14:41 JST `pnpm -w turbo run build --filter @hierarchidb/ui-batch-progress --only`（exit 0）後、`pnpm -w turbo run typecheck --filter @hierarchidb/route-plugin --filter @hierarchidb/location-plugin --only`（exit 0）を確認。
...
- done: 2026-02-17 14:42 JST `pnpm -w turbo run typecheck --filter @hierarchidb/ui-batch-progress --only` は cache replay で exit 0。
- start: 2026-02-17 14:50 JST Build 用語正準化の継続として `usePluginBatchProgress` 利用箇所を `usePluginBuildProgress` へ寄せる変更に着手。
- update: 2026-02-17 14:50 JST `@hierarchidb/ui-batch-progress` の hook 実装に Build alias 型 (`UsePluginBuildProgressOptions`, `PluginBuildProgressState`) と `usePluginBuildProgress` を追加し、location/shape の hook 呼び出し側 import を Build 名へ移行。
- done: 2026-02-17 14:50 JST `pnpm -w turbo run typecheck --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/location-plugin --filter @hierarchidb/shape-plugin --only`（exit 0）と `pnpm -w turbo run test --filter @hierarchidb/location-plugin -- --run src/common/hooks/__tests__/unit/useLocationProgress.auth.unit.test.ts`（exit 0）を確認。
...
- done: 2026-02-17 14:52 JST `pnpm -w turbo run typecheck --filter @hierarchidb/ui-batch-progress --filter @hierarchidb/location-plugin --filter @hierarchidb/shape-plugin --filter @hierarchidb/route-plugin --only` を実行し exit 0 を確認。
