...
import { i as BASE_LOCATION_TYPES, n as LocationSelectionStep, t as LocationMapPreview } from "../LocationMapPreview.js";
...
const isLocationBuildPersisted = (data) => data?.processingStatus === "completed";
	...
	getCreateStepConfigs() {
		return [
			...
			},
			{
				...
				validate: (data) => isLocationBuildPersisted(data),
				capabilities: {
...
async function getPanelComponent() {
	const { LocationPanel } = await import("../LocationPanel2.js");
	const Adapter = (props) => {
