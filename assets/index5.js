...
import { Box, Button, Card, CardActions, CardContent, Chip, Divider, LinearProgress, List, ListItem, ListItemText, Menu, MenuItem, Paper, Typography } from "@mui/material";
import Grid from "@mui/material/Grid";
import { Cached, Delete, Edit, Link, Memory, Merge, PlayArrow, Speed, Timeline } from "@mui/icons-material";
...
const ResolverPanel = ({ nodeId: _nodeId, entity, onEdit, onDelete, onTest, onCompile, onViewChain }) => {
	...
	return /* @__PURE__ */ jsxs(Box, { children: [
		/* @__PURE__ */ jsxs(Card, {
			sx: { mb: 2 },
			children: [
				/* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Box, {
					sx: {
						mt: 2,
						display: "flex",
						gap: 1,
...
//#endregion
export { ResolverPanel, PLUGIN_MANIFEST as ResolverPluginManifest, getDialogComponent, loadResolverPanelModule };
