...
const FORBIDDEN_DEPENDENCIES = ['@hierarchidb/runtime-worker', '@hierarchidb/app'];
        ...
        patterns: [
          {
            ...
            message:
              'Plugins cannot import from @hierarchidb/worker. Use @hierarchidb/api or @hierarchidb/core instead.',
          },
          {
            group: ['@hierarchidb/app'],
            message: 'Plugins cannot import from @hierarchidb/_app.',
          },
        ],
      },
    ],
