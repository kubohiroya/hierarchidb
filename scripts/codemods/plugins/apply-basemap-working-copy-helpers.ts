...
ensureNamedImport(handlerFile, '@hierarchidb/plugins-base-plugin', 'createDraftWorkingCopyBase');
...
ensureNamedImport(peerStoreFile, '@hierarchidb/plugins-base-plugin', 'createPeerStoreNormalizer');
