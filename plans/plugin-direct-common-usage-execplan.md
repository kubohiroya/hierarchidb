...
The primary targets are shape/location/route plugins under plugins/*-plugin/src. Shared packages live under packages/ and include @hierarchidb/download, @hierarchidb/ui-monitoring, @hierarchidb/ui-batch, @hierarchidb/ui-worker-client, and other shared utilities.
