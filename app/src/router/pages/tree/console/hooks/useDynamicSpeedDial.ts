...
export interface UseDynamicSpeedDialResult extends ReturnType<typeof useBaseDynamicSpeedDial> {}

export function useDynamicSpeedDial(params: {
  treeId?: TreeId;
  hidden?: boolean;
  onCreateAction: (action: string, node: unknown, options?: { openInNewTab?: boolean }) => void;
  onSuppress?: () => void;
