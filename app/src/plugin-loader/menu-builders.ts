...
import { getPresentation, prefetchAllIcons } from '../plugin-host/plugin-presentation.ts';
import { getInstalledPlugins, type InstalledPlugin } from '../plugin-host/plugin-registry.ts';
